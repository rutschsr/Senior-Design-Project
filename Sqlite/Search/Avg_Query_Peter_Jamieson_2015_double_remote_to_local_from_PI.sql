-- For Peter Jamieson 2015 double remote to local from PI
...
SELECT avg(wattage) FROM PowerMeasurement 
	...
	OR strftime('%H %M %S %f', date) BETWEEN strftime('%H %M %S %f', '2022-03-08 18:04:20.852512') AND strftime('%H %M %S %f', '2022-03-08 18:05:08.298408')
...
SELECT avg(wattage) FROM PowerMeasurement 
	...
	OR strftime('%H %M %S %f', date) NOT BETWEEN strftime('%H %M %S %f', '2022-03-08 18:04:20.852512') AND strftime('%H %M %S %f', '2022-03-08 18:05:08.298408')
